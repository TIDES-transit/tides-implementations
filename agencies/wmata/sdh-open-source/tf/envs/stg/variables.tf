...
variable "lakekeeper_app_registration_client_secret" {
  description = "A client secret for the Lakekeeper app registration in Azure AD; used for the bootstrap job to authenticate to Lakekeeper"
  type        = string
  sensitive   = true
}
...
variable "datahub_developers_group_id" {
  description = "The object ID of the DataHub Developers group in Azure AD"
  type        = string
}

variable "public_network_access_enabled" {
  description = "Whether public network access is enabled for the PostgreSQL server and Container Registry."
  type        = bool
  default     = false
}
